...
class Paginator(discord.ui.View):
    ...
    async def edit(self, ctx: Union[ApplicationContext, Context], ephemeral: bool = False, message: discord.Message = None) -> Union[discord.Message, discord.WebhookMessage]:
        """Edits a message with the paginated items.
